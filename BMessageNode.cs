...
public class BMessageNode
{
    ...
    public static BMessageNode Parse(string bMessageString)
    {
        ...
        var root = new BMessageNode(line[6..]);
                ...
                switch (line)
                {
                    ...
                    case "BEGIN:VCARD":
                        root.ChildrenNode.Add(
                            line[6..],
                            _parseRecursive(ref reader, new BMessageNode(line[6..]), lineNum, true)
                        );
                        break;
                    default:
                        root.ChildrenNode.Add(
                            line[6..],
                            _parseRecursive(ref reader, new BMessageNode(line[6..]), lineNum)
                        );
                        break;
                }
            }
