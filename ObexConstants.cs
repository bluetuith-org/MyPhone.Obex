...
{
    public static readonly byte CharsetNative = 0x00;
    public static readonly byte CharsetUtf8 = 0x01;

    public static readonly byte AttachmentOff = 0x00;
    public static readonly byte AttachmentOn = 0x01;
}
