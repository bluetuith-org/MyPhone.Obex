...
public class BluetoothClientInformation
{
    ...
    public override int GetHashCode()
    {
        ...
        hashCode =
            hashCode * -1521134295 + EqualityComparer<HostName>.Default.GetHashCode(HostName);
        hashCode =
            hashCode * -1521134295 + EqualityComparer<string>.Default.GetHashCode(ServiceName);
        return hashCode;
    }

    public static bool operator ==(
        BluetoothClientInformation? left,
        BluetoothClientInformation? right
    )
    {
